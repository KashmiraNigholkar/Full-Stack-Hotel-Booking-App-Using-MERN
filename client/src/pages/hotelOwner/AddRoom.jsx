    ...
    const onSubmitHandler
        = async (e) => {
            ...
            if (!inputs.roomType || !inputs.pricePerNight || !inputs.amenities ||
                ...
                toast.error("Please fill in alll the Details")
                return;
            }
            setLoading(true);
            try{
        ...
        <form onSUbmit={onSubmitHandler}>
                ...
                {Object.keys(images).map((key) => (
                    <label htmlFor={`roomImage${key}`} key={key}>
                        <img
                            ...
                            alt=""
                            className='max-h-32 cursor-pointer opacity-80 rounded border border-dashed border-gray-400'
                        />
                        <input
                            type="file"
                            accept="image/*"
            ...
            <div className='w-full flex max-sm:flex-col sm:gap-4 mt-4'>
                ...
                <div>
                    ...
                    <input type="number" placeholder='0' className='border border-gray-300 mt-1 rounded p-2 w-24' value={inputs.pricePerNight} onChange={e => setInputs({ ...inputs, pricePerNight: etarget.value })} />
                </div>
