...
const AllRooms = () => {
  ...
  const toggleSelection = (selectedList, setSelectedList, label) => {
    ...
    <div className="flex flex-col-reverse lg:flex-row items-start justify-between pt-28 md:pt-35 px-4 md:px-16 lg:px-24 xl:px-32">
      <div>
        ...
        {displayedRooms.map((room) => (
          <div
            key={room._id}
            className="py-10 flex gap-6 flex-col md:flex-row items-start border-b border-gray-300 last:pb-30 last:border-0"
          >
            <img
              onClick={() => {
            ...
            <div className="md:w-1/2 flex flex-col gap-2">
              ...
              <div className="flex items-center">
                <StarRatings rating={room.rating} />
          ...
          <div className="px-5 pt-5">
            ...
            {roomTypes.map((room, index) => (
              <CheckBox
                ...
                onChange={(checked, label) => toggleSelection(selectedRoomTypes, setSelectedRoomTypes, label)}
              />
            ))}
          </div>
          ...
          <div className="px-5 pt-5">
            ...
            {priceRanges.map((range, index) => (
              <CheckBox
                ...
                onChange={(checked, label) => toggleSelection(selectedPriceRanges, setSelectedPriceRanges, label)}
              />
            ))}
          </div>
