...
// Example cities array — you can replace or fetch dynamically
const cities = ["New York", "Paris", "Tokyo", "Dubai", "London"];
...
const Hero = () => {
    return (
        ...
        bg-[url("/src/assets/heroImage.png")] bg-no-repeat bg-cover bg-center h-screen'>
            ...
            <form className='bg-white text-gray-700 rounded-lg px-6 py-4 mt-8 flex flex-col md:flex-row max-md:items-start gap-4 max-md:mx-auto mt-6'>
